    ...
    <View style={tailwind('bg-white h-full')}>
      <ScrollView
        ...
        <View style={[tailwind('items-center mt-5'), {}]}>
          ...
          <Text style={[tailwind('mt-2 font-16 font-bold'), {}]}>
            {CartState?.driver_name}{' '}
          </Text>
          <Text style={[tailwind('mt-1'), {}]}>{CartState?.driver_email} </Text>
          <TouchableOpacity
            onPress={() => {
        ...
        <View>
          <Text style={[tailwind('py-3 px-3 bg-gray mt-5'), {}]}>More</Text>
          <View style={[tailwind('mt-3 '), {}]}>
            {List?.map((i: any, index: any) => {
              return (
                <TouchableOpacity
                  ...
                  />
                  <Text style={[tailwind('ml-3'), {}]}>{i?.name}</Text>
            ...
            <TouchableOpacity
              ...
              />
              <Text style={[tailwind('ml-3'), {}]}>Logout</Text>
              {/* <View style={[tailwind(''), {marginLeft: 'auto'}]}>
                    <Entypo name="chevron-right" size={20} color={'black'} />
                  </View> */}
            </TouchableOpacity>
