    ...
    <View style={[tailwind('h-full bg-white'), {}]}>
      ...
      <View
        ...
        <View style={tailwind('ml-5 flex-1')}>
          ...
          <Text style={tailwind('font-24 mt-2 font-bold')}>
      ...
      <Text style={tailwind('text-lg font-bold mt-5 mx-5')}>
        Transaction History
      </Text>
<ScrollView showsVerticalScrollIndicator={false}>
      ...
      <Modal
        ...
        <View
          ...
          <Text style={tailwind('text-lg  mx-5 font-bold mb-3')}>
            Withdraw Funds
          </Text>
          ...
          <TextInput
            ...
            style={tailwind(
              'border border-gray-300 rounded-lg  mx-5 px-4 py-2 mb-4',
            )}
