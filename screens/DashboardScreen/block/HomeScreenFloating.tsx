  ...
  return (
    <View style={[tailwind('flex-row my-2 px-3'), {width: '100%'}]}>
      <TouchableOpacity
        ...
        />
        <Text style={[tailwind('mt-3 font-bold px-3'), {}]}>
          {Response?.data?.data?.total_rides}
        </Text>
        <View style={[tailwind('items-center'), {}]}>
          <Text style={[tailwind('mt-2 font-bold'), {}]}>Today </Text>
          <Text style={[tailwind('font-bold'), {}]}> Booking</Text>
        </View>
      </TouchableOpacity>
      <TouchableOpacity
        style={[tailwind('py-3 items-center'), {width: '33%'}]}
        ...
        <Image
          ...
          style={[tailwind(''), {height: 30, width: 30}]}
        />
        <Text style={[tailwind('mt-3 font-bold px-3 text-center'), {}]} numberOfLines={2}>
         ₹{Math.round(Response?.data?.data?.total_earnings)}
        </Text>
        <View style={[tailwind('items-center'), {}]}>
          <Text style={[tailwind('mt-2 font-bold'), {}]}>Today </Text>
          <Text style={[tailwind('font-bold'), {}]}> Earnings</Text>
        </View>
      </TouchableOpacity>
      <View
        style={[tailwind('py-3 items-center '), {width: '33%'}]}>
        ...
        <View style={[tailwind('items-center'), {justifyContent:"center"}]}>
          <Text style={[tailwind('mt-2 font-bold'), {}]}>Today </Text>
          <Text style={[tailwind('font-bold'), {}]}> Km</Text>
        </View>
      </View>
    </View>
  );
