      ...
      <TouchableOpacity
        ...
        <View style={[tailwind('flex-row'), {justifyContent: 'space-evenly'}]}>
            ...
            {props?.rating !== '' ? (
              <View style={[tailwind('flex-row  items-center '), {}]}>
                ...
                <Text
                  style={[
                    tailwind(
                      ' font-18 ml-1 mt-1 font-bold text-center items-center',
                    ),
                    {},
                  ]}>
          ...
          <View style={[tailwind('items-center'), {width: '30%'}]}>
            <Text style={[tailwind('font-14'), {}]}>Fare</Text>
            <Text style={[tailwind('font-15 font-bold mt-1'), {}]}>
              ₹{Math.round(props?.fare)}
            </Text>
          </View>
          <View style={[tailwind('items-center'), {width: '20%'}]}>
            <Text style={[tailwind('font-14'), {}]}>Distance</Text>
            <Text style={[tailwind('font-15 font-bold mt-1'), {}]}>
              {props?.distance}
            </Text>
          </View>
